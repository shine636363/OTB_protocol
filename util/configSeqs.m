...
seqVTD={struct('name','soccer','path','..\dataset\OTB\soccer\img\','startFrame',1,'endFrame',392,'nz',4,'ext','jpg','init_rect', [0,0,0,0]),...
...
seqIVT={struct('name','carDark','path','..\dataset\OTB\carDark\img\','startFrame',1,'endFrame',393,'nz',4,'ext','jpg','init_rect', [0,0,0,0]),...
...
seqOther={struct('name','coke','path','..\dataset\OTB\coke\img\','startFrame',1,'endFrame',291,'nz',4,'ext','jpg','init_rect', [0,0,0,0]),...
...
seqNew50={struct('name','biker','path','..\dataset\OTB\biker\img\','startFrame',1,'endFrame',142,'nz',4,'ext','jpg','init_rect', [0,0,0,0]),... 
...
% seqs=seqIVT;
seqs=[seqIVT,seqVTD,seqOther, seqNew50];
